...
The first production candidate is RecBole `BPR` with `embedding_size=64`. It preserves dot-product style user/item embeddings, so online retrieval can remain pgvector-based.
