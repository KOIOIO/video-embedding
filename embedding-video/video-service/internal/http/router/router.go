...
func New(httpApp *app.App) *gin.Engine {
	...
	r.GET("/api/admin/recommendation/overview", recommendationAdminHandler.Overview)
	...
	r.GET("/api/admin/recommendation/preview/random-play", recommendationAdminHandler.PreviewRandomPlay)
	r.POST("/api/admin/recommendation/preview/by-question", recommendationAdminHandler.PreviewByQuestion)
