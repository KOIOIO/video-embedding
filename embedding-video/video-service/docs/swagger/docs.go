...
const docTemplate = `{
    ...
    "paths": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CommentReactionRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.CommentLikeResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/video-segments/{id}/comment-counts": {
            "get": {
                "produces": [
                    "application/json"
                ],
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.SegmentCommentCountResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/video-segments/{id}/comments": {
            "get": {
                "produces": [
                    "application/json"
                ],
    ...
    "definitions": {
        ...
        "dto.SegmentCommentCountResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/dto.SegmentCommentCountData"
                },
                "success": {
                    "type": "boolean"
                }
