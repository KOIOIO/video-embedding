...
import (
	...
	transcodeworker "legacy-video/internal/worker/transcodeworker"
	vectorworker "legacy-video/internal/worker/vectorworker"
...
func Run() {
	...
	f, err := middleware.InitFileLogger("worker")
	if err != nil {
